...
class SVMModelTestCase(unittest.TestCase):
    ...
    def setUp(self):
        """Set up the test case by creating a svm model and setting up the data."""
    ...
    def test_fit(self):
        """
        Test the `fit` method of the SVMModel class.

        The method fits the SVM model using the provided data. The method asserts that the
        Asserts:
        """
    ...
    def test_predict(self):
        ...
        The method fits the svm model using the provided data, then calls the `predict`
    ...
    def test_score(self):
        ...
        The method fits the svm model using the provided data, then calls the `score`
