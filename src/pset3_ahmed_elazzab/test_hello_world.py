...
from pset3_ahmed_elazzab.exe.hello_world import main
...
def test_hello_world():
    ...
    """
    with patch(
        "pset3_ahmed_elazzab.helloworld.get",
    ...
    with patch("sys.argv", ["executable_name", "--times=2"]):
        with patch("pset3_ahmed_elazzab.exe.hello_world.hello_world") as mock_hw:
            main()
